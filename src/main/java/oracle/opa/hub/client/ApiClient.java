...
import okio.Okio;
import oracle.opa.hub.client.auth.ApiKeyAuth;
import oracle.opa.hub.client.auth.Authentication;
import oracle.opa.hub.client.auth.HttpBasicAuth;
import oracle.opa.hub.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://opa-1228-sc.qb.lan/opa_1228_sc/opa-hub/api/12.2.8";
    ...
    public ApiClient() {
        ...
        authentications.put("opa_auth", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://opa-1228-sc.qb.lan/opa_1228_sc/opa-hub/api/12.2.8
